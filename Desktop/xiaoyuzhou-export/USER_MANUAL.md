...
- Project: `/Users/sophia/Desktop/xiaoyuzhou-export`
- Downloads: `/Users/sophia/Desktop/xiaoyuzhou-export/downloads`
- Database: `/Users/sophia/Desktop/xiaoyuzhou-export/xiaoyuzhou.db`
...
```bash
cd /Users/sophia/Desktop/xiaoyuzhou-export
python3 login.py
```
...
```bash
ls -lt /Users/sophia/Desktop/xiaoyuzhou-export/downloads | head
```
...
```bash
sqlite3 /Users/sophia/Desktop/xiaoyuzhou-export/xiaoyuzhou.db
```
...
```text
30 21 * * * /Users/sophia/Desktop/xiaoyuzhou-export/scripts/run_pipeline.sh
```
...
```bash
ls -lt /Users/sophia/Desktop/xiaoyuzhou-export/logs | head
```

Last failure marker:

```bash
cat /Users/sophia/Desktop/xiaoyuzhou-export/logs/last_failure.txt
```

Last success marker:

```bash
cat /Users/sophia/Desktop/xiaoyuzhou-export/logs/last_success.txt
```

## 9) One-command manual pipeline run

```bash
/Users/sophia/Desktop/xiaoyuzhou-export/scripts/run_pipeline.sh
```
